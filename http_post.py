...
major = Tkinter.Tk()
major.title("GO POST >")
major.geometry(win_size)

ui = Tkinter.Frame(major)
ui.grid(row=0, column=0)

tconsole = Tkinter.Text(major, width=txt_area_width, height=50)
tconsole.grid(row=0, column=1, padx=18)
...
def doPost():
    ...
    req.add_header('Uthing-Data', 'uthing; android; v4.3.1; 4.1.2; GT-I9300 Build/JZO54K; MainActivity; 116.448965; 39.958258')
...
btn_frame.grid(row=win_row, column=0, columnspan=2, pady=30)
...
btn_post.grid(row=0, column=2, padx=10, ipadx=20)
#btn2.pack()
